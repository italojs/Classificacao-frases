...
tamanho_de_treino = int(round(porcentagem_de_treino * len(Y)))
tamanho_de_teste = int(round(porcentagem_de_teste * len(Y)))
tamanho_de_validacao = int(round(len(Y) - tamanho_de_treino - tamanho_de_teste))
...
# tudo um unico valor(teste do algoritimo burro)
#Não funciona na versão python 3.x
